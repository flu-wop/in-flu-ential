      ...
      <div className="sticky top-0 h-[100dvh] w-full overflow-hidden">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 80% 60% at 50% 70%, rgba(180,120,40,0.15) 0%, transparent 70%)",
            }}
          />
        </motion.div>
        ...
        <motion.div
          ...
          style={{
            ...
            background:
              "linear-gradient(to top, #080808 0%, rgba(8,8,8,0.7) 25%, rgba(8,8,8,0.2) 55%, rgba(8,8,8,0.5) 100%)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 100% 100% at 50% 50%, transparent 30%, rgba(8,8,8,0.6) 100%)",
          }}
        />
        ...
        >
          ...
          >
            ...
            <span
              className="text-[#D4AF77] text-[10px] tracking-[0.5em] uppercase"
          ...
          >
            <span
              className="text-[9px] tracking-[0.5em] text-[#A89880]/60 uppercase"
              style={{ fontFamily: "DM Sans, sans-serif" }}
            >
              Enter
            </span>
