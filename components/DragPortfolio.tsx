...
const PROJECTS: Project[] = [
  ...
  { id:"mvc-creations",    category:"Website",    title:"MVC Creations",                     desc:"Luxury press-on nail brand — Next.js 15, editorial aesthetic, Shopify-ready.",    tags:["Next.js","Beauty","E-Commerce"], url:"https://mvc-creations.vercel.app",      accent:"#C47AA8", pattern:"repeating-linear-gradient(90deg,#C47AA811 0,#C47AA811 1px,transparent 1px,transparent 16px)", live:true },
